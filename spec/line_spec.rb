...
describe Line do
  describe '.draw' do
    ...
    context "when a horizontal line with coordinates p1(6,2) and p2(1,2)" do
    ...
    context "when a horizontal line with coordinates p1(1,2) and p2(6,2) " do
    ...
    context "when a vertical line with coordinates p1(1,2) and p2(1,4) " do
